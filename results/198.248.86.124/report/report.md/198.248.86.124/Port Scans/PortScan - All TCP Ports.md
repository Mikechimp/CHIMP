...
Scanned at 2025-05-02 18:59:37 EDT for 2435s
...
TCP/IP fingerprint:
OS:SCAN(V=7.95%E=4%D=5/2%OT=80%CT=%CU=%PV=N%DS=2%DC=T%G=N%TM=681557DC%P=x86
OS:_64-pc-linux-gnu)SEQ(SP=100%GCD=1%ISR=100%TI=I%II=I%SS=S%TS=U)OPS(O1=M5B
...
OS:=N%TG=80%S=O%A=S+%F=AS%RD=0%Q=)T2(R=N)T3(R=Y%DF=N%TG=80%W=FAF0%S=O%A=S+%
...
HOP RTT      ADDRESS
1   0.55 ms  192.168.211.2
2   40.67 ms 198.248.86.124
