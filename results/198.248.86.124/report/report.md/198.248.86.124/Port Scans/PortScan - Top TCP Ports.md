...
```
# Nmap 7.95 scan initiated Sat May  3 02:29:02 2025 as: /usr/lib/nmap/nmap --privileged -vv --reason -Pn -T4 -sV -sC --version-all -A --osscan-guess -oN /home/kali/rp1/results/198.248.86.124/scans/_quick_tcp_nmap.txt -oX /home/kali/rp1/results/198.248.86.124/scans/xml/_quick_tcp_nmap.xml 198.248.86.124
Increasing send delay for 198.248.86.124 from 0 to 5 due to 11 out of 19 dropped probes since last increase.
Increasing send delay for 198.248.86.124 from 5 to 10 due to 11 out of 21 dropped probes since last increase.
Nmap scan report for 198.248.86.124
Host is up, received user-set (0.12s latency).
Scanned at 2025-05-03 02:29:02 EDT for 609s
...
Aggressive OS guesses: DD-WRT v24-sp2 (Linux 2.4.37) (95%), Actiontec MI424WR-GEN3I WAP (94%), Linux 3.2 (92%), Linux 4.4 (92%), Microsoft Windows XP SP3 or Windows 7 or Windows Server 2012 (91%), Microsoft Windows XP SP3 (88%), VMware Player virtual NAT device (87%), BlueArc Titan 2100 NAS device (86%)
No exact OS matches for host (test conditions non-ideal).
TCP/IP fingerprint:
SCAN(V=7.95%E=4%D=5/3%OT=80%CT=8080%CU=%PV=N%DS=2%DC=T%G=N%TM=6815BA0F%P=x86_64-pc-linux-gnu)
SEQ(SP=107%GCD=1%ISR=103%TI=I%II=I%SS=S%TS=U)
SEQ(SP=F3%GCD=1%ISR=F5%TI=I%II=I%TS=U)
...
HOP RTT       ADDRESS
1   0.98 ms   192.168.211.2
2   308.62 ms 198.248.86.124

Read data files from: /usr/share/nmap
OS and Service detection performed. Please report any incorrect results at https://nmap.org/submit/ .
# Nmap done at Sat May  3 02:39:11 2025 -- 1 IP address (1 host up) scanned in 609.02 seconds
